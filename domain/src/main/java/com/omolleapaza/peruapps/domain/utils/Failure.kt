package com.omolleapaza.peruapps.domain.utils
...
sealed class Failure {
    ...
    /** Extend this class for feature specific SERVICE ERROR BODY RESPONSE.*/
    open class ServerBodyErrorForLogin(val code: String, val status: String, val url: String, val title: String, val message: String) : Failure()
